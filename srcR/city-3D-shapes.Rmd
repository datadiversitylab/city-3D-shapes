...
for (city_name in city_names_list) {
  ...
  ggsave(paste("../results/figures/folder1/", city_name, "-plot.png"), plot = p, width = 8, height = 6, units = "in", dpi = 300, bg="white")
  ...
  # Save the plot as a .png file without labels or background
  #bg = "transparent"
  ggsave(paste("../results/figures/folder2/", city_name, "-area-vs-height-map.png"), plot = p, width = 8, height = 6, units = "in", dpi = 300, bg = "white")
...
# skip_cities <- c('Bathurst1', 'Bathurst2', 'Beijing', 'Bhagalpur', 'Cadiz1', 'Cadiz2', 'Calcutta')
...
for (city_name in city_names_list) {
  ...
  output_file <- paste0("city_height_", city_name, ".tif")
...
csv_file <- "../docs/combined_summary_1000.csv"
